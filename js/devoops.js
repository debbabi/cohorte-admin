...
function MorrisDashboard(){
	Morris.Line({
		element: 'stat-graph',
		data: [
			{"period": "2014-09-16", "Total": 34, "cohorte": 13, 'app': 21},
			{"period": "2014-09-15", "Total": 33, "cohorte": 13, 'app': 20},
			{"period": "2014-09-14", "Total": 28, "cohorte": 10, 'app': 18},
			{"period": "2014-09-13", "Total": 16, "cohorte": 5, 'app': 11}
		],
		xkey: 'period',
		ykeys: ['Total', 'cohorte','app'],
		labels: ['Total', 'cohorte','app']
	});
	Morris.Donut({
